...
class Board:
    ...
    def __init__(self, dim_size, num_bombs):
        ...
        self.dug = set()  # if we dig at 0,0 then slef.dug = {(0,0)}
    ...
    def assign_values_to_board(self):
        # now that we have the bombs planted,let's assign a number 0-8 for all the empty space
        # represent how many neighboring bombs there are. we can precompute these and it'll save
    ...
    def get_num_neighboring_bombs(self, row, col):
        # les's iterate through each of the neighboring positions and sum number of bombs
    ...
    def dig(self, row, col):
        # dig at that lacation
        # return True if sucessful dig, False if bomb dug
        # a few scenarios:
        # hit a bomb game over
        # dig at locations with neighboring bombs---> recursively dig neighbores!
    ...
    def __str__(self):
        ...
        for idx in range(self.dim_size):
            column = map(lambda x: x[idx], visible_board)
...
def play(dim_size=10, num_bombs=10):
    ...
    #step 3b: if location is not a bomb,dig recursively until each square is at
